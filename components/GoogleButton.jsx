...
export default function GoogleButton() {
  ...
  const handleClick = async () => {
    ...
    // On success the browser is already navigating to Google; do nothing.
  };
  ...
  return (
    <button
      ...
      disabled={loading}
      type="button"
      className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-5 py-2.5 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 disabled:opacity-60 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
    >
