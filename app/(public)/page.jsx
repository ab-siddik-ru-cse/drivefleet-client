...
const FEATURES = [
  {
    ...
    text: "Every host is identity-checked before they can list a car.",
  },
  {
    icon: Clock,
    title: "Instant Booking",
    text: "Book your dream car instantly without waiting.",
  },
  {
    icon: CreditCard,
  ...
  },
  {
    icon: Headphones,
    title: "24/7 Support",
    text: "Dedicated support team ready anytime you need help.",
  },
];
  ...
  return (
    <>
          ...
          <div className="max-w-3xl text-white">
            ...
            <div className="mt-14 grid max-w-xl grid-cols-3 gap-6">
              <div>
                ...
                <p className="text-sm text-white/70">Premium Cars</p>
              </div>
      ...
      <section className="container mx-auto px-4 pb-24">
        <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-r from-brand-700 to-brand-500 px-8 py-20 text-center text-white shadow-2xl">
